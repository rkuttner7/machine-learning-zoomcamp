...
The docker image is published to [`agrigorev/model-2025-hairstyle:v1`](https://hub.docker.com/r/agrigorev/model-2025-hairstyle/tags).
...
# explore the image
docker run -it --rm --entrypoint=bash agrigorev/model-2025-hairstyle:v1
```
...
```BASH
docker build -t zoomcamp-hw9 .

docker run -it --rm -p 8080:8080 zoomcamp-hw9
